...
function validateDetectorChildren(ref) {
  ...
  if (__DEV__ && Platform.OS !== 'web') {
    ...
    ref._reactInternalFiber.elementType; // eslint-disable-next-line @typescript-eslint/no-unsafe-assignment, @typescript-eslint/no-unsafe-member-access, @typescript-eslint/no-unsafe-call
...
export const GestureDetector = props => {
  ...
  const webEventHandlersRef = useRef({
    ...
    onGestureHandlerStateChange: isExperimentalWebImplementationEnabled() ? e => {
      onGestureHandlerEvent(e.nativeEvent);
    } : undefined
  });
