...
export const TutorialTheory = ({ visible, setModalVisible }) => {
  ...
  const tutorialData = [
    {
      title: 'tutorial title theory 1',
      text: 'tutorial theory 1',
      image: require('../../assets/Robo_pensativo_centralizado.png'),
      content: "image",
    },
    {
      title: 'tutorial title theory 2',
      text: 'tutorial theory 2',
      image: require('../../assets/Tutorial_code.gif'),
      content: "gif",
    },
    {
      title: 'tutorial title theory 3',
      text: 'tutorial theory 3',
      image: require('../../assets/Tutorial_indexWeb.gif'),
      content: "gif",
    },
    {
      title: 'tutorial title theory 4',
      text: 'tutorial theory 4',
...
export const TutorialOption = ({ visible, setModalVisible }) => {
  ...
  const tutorialData = [
    {
      title: 'tutorial title option 1',
      text: 'tutorial option 1',
      image: require('../../assets/Robo_pensativo_centralizado.png'),
      content: "image",
    },
    {
      title: 'tutorial title option 2',
      text: 'tutorial option 2',
      image: require('../../assets/Tutorial_code.gif'),
      content: "gif",
    },
    {
      title: 'tutorial title option 3',
      text: 'tutorial option 3',
      image: require('../../assets/Tutorial_indexWeb.gif'),
      content: "gif",
    },
    {
      title: 'tutorial title timer',
      text: 'tutorial timer',
      image: require('../../assets/Tutorial_web.gif'),
      content: "gif",
    },
...
export const TutorialText = ({ visible, setModalVisible }) => {
  ...
  const tutorialData = [
    {
      title: 'tutorial title text 1',
      text: 'tutorial text 1',
      image: require('../../assets/Robo_pensativo_centralizado.png'),
      content: "image",
    },
    {
      title: 'tutorial title text 2',
      text: 'tutorial text 2',
      image: require('../../assets/Tutorial_code.gif'),
      content: "gif",
    },
    {
      title: 'tutorial title text 3',
...
export const TutorialSelect = ({ visible, setModalVisible }) => {
  ...
  const tutorialData = [
    {
      title: 'tutorial title select 1',
      text: 'tutorial select 1',
      image: require('../../assets/Robo_pensativo_centralizado.png'),
      content: "image",
    },
    {
      title: 'tutorial title select 2',
      text: 'tutorial select 2',
      image: require('../../assets/Tutorial_code.gif'),
      content: "gif",
    },
    {
      title: 'tutorial title select 3',
      text: 'tutorial select 3',
      image: require('../../assets/Tutorial_indexWeb.gif'),
      content: "gif",
    },
    {
